...
headers=`find base enums error_estimation fe geom mesh numerics parallel partitioning particles physics quadrature reduced_basis solution_transfer solvers systems utils -name "*.h" -o -name "*specializations" -type f | LC_COLLATE=POSIX sort`
